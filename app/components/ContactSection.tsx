			...
			<div className="max-w-4xl mx-auto text-center">
				...
				>
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						I’m always excited to collaborate on projects involving <span className="text-blue-400">Python, Django, DRF</span>, and modern 
						DevOps practices. Whether it’s building scalable systems or solving real-world problems with tech, I’d love to connect.
					</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:couragemhute21@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/couragemhute"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/courage-mhute-8a2b71220/"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
